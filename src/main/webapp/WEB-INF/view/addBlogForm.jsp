...
<body>
	...
	<div class="ui top attached tabular menu">
		  <div class="active item" data-tab="addBlogTab">Add Blog</div>
	</div>
	<div class="ui bottom attached active tab segment" data-tab="addBlogTab">
		<form class="demo" action="addBlog.html" method="post"	id="addBlogFormId" enctype="multipart/form-data">
				<table id="contentTabId" class="ui very basic table">
				  <thead>
				   ...
				   <tbody>
				   		<tr>
							<td><div class="ui teal medium label" data-tooltip="Menu information" data-position="top left">Menu</div></td>
						...
						<tr>
							<td><div class="ui teal medium label" data-tooltip="Sub Menu information" data-position="top left">Sub Menu*</div></td>
							<td><select class="ui dropdown" id="subMenuId" name="subMenuId">
									<option value="">Select Sub Menu</option>
							</select></td>
						</tr>
						<tr>
							<td><div class="ui teal medium label" data-tooltip="Title information" data-position="top left">Title*</div></td>
							<td><input type="text" id="titleId" name="titleId"></td>
						</tr>
						<tr>
							<td><div class="ui teal medium label" data-tooltip="Tags information" data-position="top left">Tags*</div></td>
							<td><input type="text" id="tags" name="tags">Please  only Put tags " ; " Seprated. E.g. Java;Spring;Cloud</td>
						</tr>
						<tr>
					...
					<div id="createBlogId" class="ui tiny green button">Create Blog</div>
